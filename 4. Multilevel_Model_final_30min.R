...
#write.csv(coeff, "D:/Accessibility_study/Final isochrones1/Summary/coefficients_grocery_30min.csv")
...
#write.csv(gro_prob, "D:/Accessibility_study/Final isochrones1/Summary/probability_grocery_30min.csv")
...
write.csv(coeff, "D:/Accessibility_study/Final isochrones1/Summary/coefficients_health_nu_30min.csv")
...
#write.csv(health_prob, "D:/Accessibility_study/Final isochrones1/Summary/probability_health_30min_nu.csv")
...
#write.csv(coeff, "D:/Accessibility_study/Final isochrones1/Summary/coefficients_health_u_30min.csv")
...
#write.csv(health_u_prob, "D:/Accessibility_study/Final isochrones1/Summary/probability_health_30min_u.csv")



################### fixed effect plots #########################
coeff_gro = read.csv("D:/Accessibility_study/Final isochrones1/Summary/coefficients_grocery_30min.csv",
                     stringsAsFactors = FALSE)
coeff_he_nu = read.csv("D:/Accessibility_study/Final isochrones1/Summary/coefficients_health_nu_30min.csv",
                    stringsAsFactors = FALSE)
coeff_he_u = read.csv("D:/Accessibility_study/Final isochrones1/Summary/coefficients_health_u_30min.csv",
                    stringsAsFactors = FALSE)
...
gro_m1_p2 = interact_plot(gro_model1, p_pov_z, suburban, "gro12_mid_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
gro_m1_p3 = interact_plot(gro_model1, p_nwhi_z, suburban, "gro12_mid_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
gro_m2_p2 = interact_plot(gro_model2, p_pov_z, suburban, "gro13_mid_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
gro_m2_p3 = interact_plot(gro_model2, p_nwhi_z, suburban, "gro13_mid_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
gro_m3_p2 = interact_plot(gro_model3, p_pov_z, suburban, "gro12_morn_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
gro_m3_p3 = interact_plot(gro_model3,  p_nwhi_z, suburban,"gro12_morn_30")  +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
gro_m4_p2 = interact_plot(gro_model4, p_pov_z, suburban, "gro13_morn_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
gro_m4_p3 = interact_plot(gro_model4,  p_nwhi_z, suburban,"gro13_morn_30")   +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m1_p2 = interact_plot(he_model1, p_pov_z, suburban, "he12_mid_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
he_m1_p3 = interact_plot(he_model1, p_nwhi_z, suburban, "he12_mid_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m2_p2 = interact_plot(he_model2, p_pov_z, suburban, "he13_mid_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
he_m2_p3 = interact_plot(he_model2, p_nwhi_z, suburban, "he13_mid_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m3_p2 = interact_plot(he_model3, p_pov_z, suburban, "he12_morn_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
he_m3_p3 = interact_plot(he_model3, p_nwhi_z, suburban, "he12_morn_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m4_p2 = interact_plot(he_model4, p_pov_z, suburban, "he13_morn_30")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15)) 
he_m4_p3 = interact_plot(he_model4, p_nwhi_z, suburban,"he13_morn_30") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m1_p2_u = interact_plot(he_u_model1, p_pov_z, suburban, "he12_mid_30_u")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
he_m1_p3_u = interact_plot(he_u_model1, p_nwhi_z, suburban, "he12_mid_30_u") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m2_p2_u = interact_plot(he_u_model2, p_pov_z, suburban, "he13_mid_30_u")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
he_m2_p3_u = interact_plot(he_u_model2, p_nwhi_z, suburban, "he13_mid_30_u") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m3_p2_u = interact_plot(he_u_model3, p_pov_z, suburban, "he12_morn_30_u")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
he_m3_p3_u = interact_plot(he_u_model3, p_nwhi_z, suburban, "he12_morn_30_u") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
he_m4_p2_u = interact_plot(he_u_model4, p_pov_z, suburban, "he13_morn_30_u")+ 
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
he_m4_p3_u = interact_plot(he_u_model4, p_nwhi_z, suburban,"he13_morn_30_u") +   
  scale_y_continuous(breaks=seq(0.0, 0.15, 0.1), limits=c(0, 0.15))
...
shp = st_read("D:/Accessibility_study/Final isochrones1/Shapefiles_new/Original shapefiles/probability_30min.shp")
shp$weighted_i[4] = 0
shp$sprawl[4] = 0
shp$sprawl = as.numeric(shp$sprawl)
shp = st_transform(shp, 4326)
shp_cen = st_centroid(shp)
