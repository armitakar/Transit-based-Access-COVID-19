...
#read data
he_45_morn = read.csv("D:/Accessibility_study/Final isochrones1/Summary/health_2700_morning_u.csv")
he_45_mid = read.csv("D:/Accessibility_study/Final isochrones1/Summary/health_2700_midday_u.csv")
...
dat_mid12 = est_cut(he_45_mid, "Precovid vs covid")
cut = merge(Index, dat_mid12, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'he_45_mid12'

dat_mid13 = est_cut(he_45_mid, "Precovid vs postcovid")
cut = merge(cut, dat_mid13, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'he_45_mid13'

dat_morn12 = est_cut(he_45_morn, "Precovid vs covid")
cut = merge(cut, dat_morn12, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'he_45_morn12'

dat_morn13 = est_cut(he_45_morn, "Precovid vs postcovid")
cut = merge(cut, dat_morn13, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'he_45_morn13'

cut$diff_mid = cut$he_45_mid13 /cut$he_45_mid12
cut$diff_morn = cut$he_45_morn13 /cut$he_45_morn12


#### Loss in access to health ####
dat_mid12 = est_cut(gro_45_mid, "Precovid vs covid")
cut = merge(cut, dat_mid12, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'gro_45_mid12'

dat_mid13 = est_cut(gro_45_mid, "Precovid vs postcovid")
cut = merge(cut, dat_mid13, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'gro_45_mid13'

dat_morn12 = est_cut(gro_45_morn, "Precovid vs covid")
cut = merge(cut, dat_morn12, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'gro_45_morn12'

dat_morn13 = est_cut(gro_45_morn, "Precovid vs postcovid")
cut = merge(cut, dat_morn13, by.x= "City", by.y = "City", all.y = TRUE)
colnames(cut)[colnames(cut) == 'pct_cut'] <- 'gro_45_morn13'

cut$diff_mid_gro = cut$gro_45_mid13 /cut$gro_45_mid12
cut$diff_morn_gro = cut$gro_45_morn13 /cut$gro_45_morn12

#### export file####
write.csv(cut, "D:/Accessibility_study/Final isochrones1/Summary/service_cut_pct_blg_45_u.csv")
#write.csv(cut, "D:/Accessibility_study/Final isochrones1/Summary/service_cut_pct_blg_45_nu.csv")
...
serv_cut = read.csv('D:/Accessibility_study/Final isochrones1/Summary/service_cut_pct_blg_45_nu.csv')
cut = serv_cut


he_plot1 = sprawl_plot(cut, he_45_mid12, "he_45_mid12") 
he_plot2 = sprawl_plot(cut, he_45_mid13, "he_45_mid13")
he_plot3 = sprawl_plot(cut, he_45_morn12, "he_45_morn12")
he_plot4 = sprawl_plot(cut, he_45_morn13, "he_45_morn13")


gro_plot1 = sprawl_plot(cut, gro_45_mid12, "gro_45_mid12")
gro_plot2 = sprawl_plot(cut, gro_45_mid13, "gro_45_mid13")
gro_plot3 = sprawl_plot(cut, gro_45_morn12, "gro_45_morn12")
gro_plot4 = sprawl_plot(cut, gro_45_morn13, "gro_45_morn13")
